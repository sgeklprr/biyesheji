...
<script setup>
    ...
    import { useChangdiCreateForm, canChangdiInsert } from "@/module";
    ...
    const { form } = useChangdiCreateForm();
                        ...
                        (res) => {
                            ...
                            if (res.code == 0) {
                                ...
                                if (props.isHouxu) {
                                    ...
                                    form.changdibianhao = rule.getID();
                                }
                            } else {
